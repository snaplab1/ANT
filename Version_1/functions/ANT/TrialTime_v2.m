...
pltBH_group = 1;
saveplt     = 1;             % Save plot (to local folder)?
...
saveGroupData = 1;
    switch whichStudy
        case 'Behav'
            groupDir = 'C:\Users\mmasl\OneDrive - Marquette University\Desktop\SNAP LAB\ANT\Data'; % **PAR YOU MAY NEED TO UPDATE**
        case 'MRI'         
            %groupDir = '/Users/ggurariy/Dropbox/CI_Testing/fMRI/ANT/Data/group/';
            groupDir = '/home/eduwell/SynologyDrive/SNAP/projects/chemoBrain/forChris/fMRI/ANT/Data/group/'; % **PAR YOU MAY NEED TO UPDATE**
    end
...
SubjID   = {"POCD_CS3"}; % **PAR YOU MAY NEED TO UPDATE**
ScanDays = [1];          % Scan Days
errB     = 'ste';        % errorbars: use ste or std % **PAR YOU MAY NEED TO UPDATE**
...
switch whichStudy
    case 'MRI'
        %DataFolder  = strcat('/Users/'Data'; % for behavioral
dataSubDir='forChris/fMRI/ANT/Data'; % for fMRI % **PAR YOU MAY NEED TO UPDATE**,cp_split{3},'/Dropbox/CI_Testing/fMRI/ANT/Data/');
        DataFolder  = "/home/eduwell/SynologyDrive/SNAP/projects/chemoBrain/forChris/fMRI/ANT/Data/"; % **PAR YOU MAY NEED TO UPDATE**
    case 'Behav'
        %DataFolder  = strcat('/Users/',cp_split{3},'/Dropbox/CI_Testing/Behavioral/ANT/Data/'); 
        DataFolder  = "C:\Users\mmasl\OneDrive - Marquette University\Desktop\SNAP LAB\ANT\Data\"; % **PAR YOU MAY NEED TO UPDATE**
end

...
directory = '/Users/umfleet-lab/Desktop/SCD_Testing/Behavioral/ANT/Data/';
...
% whichHemifeild = 'R';  % Options: Left ['L'], Right ['R'], or Center ['C']
 whichExp = 'behav';    % Options: behavioral 'b' (will use left/right keys) or 'f' (will use 2 & 3 keys)
 whichExp = lower(whichExp(1));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%    directory = '/Users/ggurariy/Dropbox/CI_Testing/Behavioral/ANT/Data/';
%    room = 'GenaImacMCW';
%else
%   directory = '/Users/snap-lab-g/Dropbox/CI_Testing/Behavioral/ANT/Data/';
%   room = 'SoundChamber';
%end
...
cd(directory);
%try
%    save('-v7',fileid,'trialprop','-append');
%catch
...
cd(directory);
%try
%    save('-v7',fileid,'trialtm','trialch','response','blockstart','blockstop','-append');
%catch

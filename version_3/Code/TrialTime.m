...
% Subject & scan info
SubjID   = {"rr"};       % All Subject IDs {"BJV","BTR","JDV","JVV","KML","MMJ","MXP","TXC","GXS"}
...
for s = 1:numel(SubjID)
    ...
    for d = ScanDays
        ...
        SaveFolder = strcat(DataFolder,SubjID{1,s},'/day',num2str(d));
        ...
        for r = 1:Nruns
            ...
            if strcmp(SubjID{s},'JXX') && d == 1 && r ==1
                trialtm(1,35:36) = 0;
                response(1,35:36) = 0;
            end
            
            if strcmp(SubjID{s},'JXX') && d == 1 && r ==3
                trialtm(1,23:36) = 0;
                response(1,23:36) = 0;
            end
            
            if strcmp(SubjID{s},'JXX') && d == 1 && r ==4
                trialtm(1,3:36) = 0;
                response(1,3:36) = 0;
            end
           ...
           AccuracyStore(d,r) =  numel(find(response==1))/size(trialprop,1);

...
saveGroupData = 1;
    switch whichStudy
        case 'Behav'
            groupDir = '/Users/Shared/ANT/ANT_update_8_14_24/Behavioral/ANT/'; % **PAR YOU MAY NEED TO UPDATE**
        case 'MRI'         
...
SubjID   = {"POCD_AV_t1"}; % **PAR YOU MAY NEED TO UPDATE**
ScanDays = [1];          % Scan Days
errB     = 'ste';        % errorbars: use ste or std % **PAR YOU MAY NEED TO UPDATE**

Nruns    = 7;           % Set which runs to process, or leave empty for script to find runs automatically
...
dataSubDir='forChris/fMRI/ANT/Data'; % for fMRI % **PAR YOU MAY NEED TO UPDATE**,cp_split{3},'/Dropbox/CI_Testing/fMRI/ANT/Data/');
        DataFolder  = "/Users/Shared/ANT/ANT_update_8_14_24/Behavioral/ANT/Data/"; % **PAR YOU MAY NEED TO UPDATE**
    case 'Behav'

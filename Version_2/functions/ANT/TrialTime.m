...
% modified back for no invalid/valid on 9/3/2025
...
switch whichStudy
    ...
    case 'Behav'
        DataFolder  = ('/Users/Shared/ANT/ANT_update_8_14_24/Behavioral/ANT/Data/POCD_MTt1');
end
...
%        export_fig(strcat(upper(SubjID{1,s}),'_ANT'), Fmt, qOpt, mOpt);
 ...
 if saveGroupData
    cd(groupDir)
    save([SubjID{1}, '_Data.mat'], 'RT_Subj', 'AccuracyStore')
 end
